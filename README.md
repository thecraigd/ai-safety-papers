...
- **LLM-powered filtering** using OpenAI GPT-5.6 Luna to identify safety-relevant papers
...
- `OPENAI_REASONING_EFFORT` - Optional reasoning override; defaults to `none`
